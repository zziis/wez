...
const STATIC_FILES=[
  './','./index.html','./manifest.json?v=2.9.0',
  './css/style.css?v=2.9.0','./css/responsive.css?v=2.9.0',
  './js/iraq-data.js?v=2.9.0','./js/voice-assistant.js?v=2.9.0',
  './js/hazards-manager.js?v=2.9.0','./js/offline-manager.js?v=2.9.0',
  './js/map-engine.js?v=2.9.0','./js/app.js?v=2.9.0',
  './assets/images/logo.jpg?v=2.9.0','./assets/images/splash.jpg','./assets/waze-import/destination-pin.png?v=2.9.0','./assets/waze-import/departure-pin.png?v=2.9.0','./assets/waze-import/search-pin.png?v=2.9.0'
];
